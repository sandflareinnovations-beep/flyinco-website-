...
const BrowseCategories = () => {
    return (
        <section className="py-14 md:py-24 bg-gray-50" id="categories">
            <div className="max-w-[1240px] mx-auto px-4">

                <div className="mb-12 flex flex-col items-center">
                    <p className="font-display text-primary font-bold uppercase tracking-[0.2em] text-xs mb-3 text-center">Your Style</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    ...
                    <div className="relative h-[320px] md:h-[400px] rounded-[2rem] md:rounded-[3rem] overflow-hidden group shadow-sm hover:shadow-2xl transition-all duration-700 cursor-pointer">
                        <img loading="lazy" src="https://images.unsplash.com/photo-1501555088652-021faa106b9b?auto=format&fit=crop&q=80&w=1200" alt="Adventure" className="w-full h-full object-cover transform scale-100 group-hover:scale-110 transition-transform duration-[2s]" />
                        <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/40 to-transparent p-8 md:p-12 flex flex-col justify-center">
